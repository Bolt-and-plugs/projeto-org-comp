...
\newpage
\begin{abstract}
Este relatório analisa a família de processadores M a apple, responsável por uma mudança estratégica na tecnologia de chips da Apple, representando a transição dos processadores x86-64 para uma arquitetura baseada em ARM. Com o desempenho e eficiência como seus pontos fortes, a Apple Silicon unifica componentes essenciais como CPU, GPU e memória em um único chip (SoC), facilitando a comunicação entre os mesmos. Este estuda aborda as principais características e evolução das três gerações de processadores, destacando suas capacidades avaçandas para computação gráfica e aprendizado de máquina, posicionando a Apple como referência em design de chips de alto desempenho.O trabalho oferece uma análise abrangente da importância da arquitetura ARM para a série M e discute como a Apple redefiniu os limites do design de processadores modernos.
